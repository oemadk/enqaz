...
export const ROUTES: RouteInfo[] = [
    ...
    // {
    //     path: '/dashboard/dashboard1', title: 'Dashboard', icon: 'ft-home', class: 'has-sub', badge: '2', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
        
    //     ]
    // },
            { path: '/dashboard/dashboard2', title: 'Dashboard', icon: 'ft-home', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },

        { path: '/services', title: 'Services', icon: 'ft-life-buoy', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/customers', title: 'Customers', icon: 'ft-users', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/vendors', title: 'Vendors', icon: 'ft-tag', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    // {
    //     path: '', title: 'Operators', icon: 'ft-tag', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
    //         // { path: '/operator/customer', title: 'Customer', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    //         { path: '/operator/delivery', title: 'Delivery', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    //         // { path: '/operator/washing', title: 'Washing', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    //         { path: '/operator/ironing', title: 'Ironing & Washing', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    //         { path: '/operator/labeling', title: 'Labeling', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    //     ]
    // },
